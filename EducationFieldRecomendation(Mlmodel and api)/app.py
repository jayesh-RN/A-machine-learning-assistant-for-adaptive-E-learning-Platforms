...
class_names = ['Systems Analyst', 'Database Administrator (DBA)', 'Network Engineer', 'Compiler Engineer', 'Unknown',
               'Software Engineer', 'Algorithm Engineer', 'Software Developer', 'Scientist',
               'Data Scientist', 'Machine Learning Engineer', 'Quality Assurance Engineer', 'Security Analyst',
               'DevOps Engineer', 'Game Developer', 'Stock Investor',
               'Cloud Engineer']
